...
import staffs from "@/staffsData/staffs.json";
import Image from "next/image";
export default function Stuffs() {
  const [displayCount, setDisplayCount] = useState(8); // Initial count to display

  // Function to increase the count and show more staff members
  const showMore = () => {
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="container px-6 py-10 mx-auto">
          ...
          <p className="max-w-4xl mx-auto my-6 text-center text-gray-300 dark:text-gray-300">
            ...
            officer’s. Our staffs or faculty members are highly educated and
            already achieve Graduates, Post-Graduates, M.Phil and Ph.D degree
            from world class reputed public, private, national and international
          ...
          <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-4">
            {staffs.slice(0, displayCount).map((staff) => (
              ...
              >
                ...
                <p className="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300 tracking-tighter text-sm">
                  {staff.position}
                </p>
          ...
          <div className="flex justify-center pt-5">
            {staffs.length > displayCount ? (
              <button
                className=" bg-slate-50 px-10 py-2 rounded-sm font-medium hover:bg-slate-200"
                onClick={showMore}
              >
                Show More
              </button>
