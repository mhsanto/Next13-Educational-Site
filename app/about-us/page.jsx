      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2 place-content-center w-full h-full">
          <div className="flex flex-col gap-3">
            <h3 className="text-3xl underline underline-offset-4 font-medium">
              About Us
            </h3>
            <p className="tracking-tight leading-6 text-sm max-w-[80ch]">
              ...
              high-quality education. Under the National University&apos;s
              banner, BIST offers a range of enriching four-year B.Sc. (Hons.)
              degree programs. Students can choose from a selection of exciting
              ...
              for advanced education in these fields. But that&apos;s not all.
              BIST also enjoys affiliation with the esteemed Bangladesh
              Technical Education Board (BTEB). Here, our institution welcomes
              numerous students pursuing diploma courses in engineering across a
              variety of captivating subjects. The diverse range of subjects
              includes Computer Technology, Electrical Technology, Electronics
              ...
              BIST&apos;s journey began with just a handful of students, and
              today, we are proud to have nurtured a thriving community with
              thousands of enthusiastic learners. To date, we have seen over 800
              graduates emerge from our institution, each of them securing
              promising positions in their respective fields. At BIST, we are
              passionately dedicated to nurturing the growth of human resources
              within the ready-made garment, textile, and allied sectors of
              Bangladesh. We aspire to establish ourselves as a &apos;center of
              excellence&apos; in the realms of study, research, and
              development, with a steadfast commitment to serving our nation
            </p>
          </div>
